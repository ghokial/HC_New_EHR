const patients = [
  {id:1, initials:"AM", name:"Alain M.", mrn:"HC-100241", unin:"243-10L-M192-00003", dob:"12 Mar 1992", sex:"Male", type:"Outpatient", service:"Cardiology", provider:"Dr. Jane Doe", status:"Open", time:"08:30"},
  {id:2, initials:"CK", name:"Chantal K.", mrn:"HC-100242", unin:"Not assigned", dob:"28 Jun 1985", sex:"Female", type:"Inpatient", service:"Medicine", provider:"Dr. Jane Doe", status:"Open", time:"09:15"},
  {id:3, initials:"JM", name:"Joseph M.", mrn:"HC-100243", unin:"Not assigned", dob:"03 Nov 1976", sex:"Male", type:"ED", service:"Emergency", provider:"Dr. Jane Doe", status:"Closed", time:"10:00"},
  {id:4, initials:"SN", name:"Sarah N.", mrn:"HC-100244", unin:"Not assigned", dob:"17 Jan 2001", sex:"Female", type:"Outpatient", service:"Neurology", provider:"Dr. Jane Doe", status:"Open", time:"11:30"}
];
...
function notes(){return moduleList("Clinical documentation","Clinical notes","Progress, consult, discharge, operative, and nursing notes.",[["Progress note","Draft · Dr. Jane Doe","Pending"],["Consult note","Signed · Cardiology","Signed"],["Discharge note","Signed · Medicine","Signed"]],["Note type","Author / state","Status"],"Write note")}
function audit(){return moduleList("Accountability","Audit trail","Every chart view and change is logged with actor, action, time, and context.",[["VIEW · Patient chart","Dr. Jane Doe · Clinical EHR","Final"],["UPDATE · Clinical note","Dr. Jane Doe · Clinical EHR","Final"],["VIEW · UNIN validation","Registry service · API","Final"]],["Action","Actor / context","Logged"],null)}
